...
cpu_features! {
    ...
    pub enum CPUFeature {
        ...
        AMXBF16           (edx, "AMX Tile Compuation on bfloat16 Numbers", CPUIDRequest::ExtendedFeatures1) = 1 << 22,
        ...
        SpecControl       (edx, "Indirect Brnach Restricted Speculation and Indirect Branch Prediction Barrier", CPUIDRequest::ExtendedFeatures1) = 1 << 26,
        ...
        PPIN              (ebx, "Intel Protected Procssory Inventory Number: IA32_PPIN_CTL MSR", CPUIDRequest::ExtendedFeatures2) = 1 << 0,
        ...
        ExtendedAPIC      (ecx, "Exnteded APIC Space", CPUIDRequest::ExtendedFeatures4) = 1 << 3,
